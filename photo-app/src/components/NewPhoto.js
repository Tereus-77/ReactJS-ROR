...
const NewPhoto = () => {
    ...
    const handlePhotoSubmit = (event) => {
        ...
        if (photoObject.name === '' && photoObject.desc === '') {
            ...
            setIsLoading(true)
            axios.post('/galleries/' + params.id + "/photos",  data , { headers: { 'Content-Type': 'application/json', Accept: "*/*", Authorization: `Bearer ${localStorage.getItem('token')}` } })
                .then(response => {
    ...
    return (
        <div>
            ...
            <div className="container mt-5">
                <h2 className="text-muted font-bold mb-3">New Photo</h2>
